...
export type ReservationListProps = ReservationProps & {
  ...
  onRefresh?: () => void;
  /** Extractor for underlying FlashList. Ensure that this is unique per item, or else scrolling may have duplicated and / or missing items.  */
...
class ReservationList extends Component<ReservationListProps, State> {
  ...
  private list: React.RefObject<FlashListRef<DayAgenda>> = React.createRef();
